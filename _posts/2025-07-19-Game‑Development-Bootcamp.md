...
tags: [game-dev, product-management, indie-dev, cross-platform, professional-development]
categories: career-growth
thumbnail: https://wallpapers.com/images/hd/game-development-1080-x-1080-wallpaper-hrebdwrbqbhxipcr.jpg
pretty_table: true
---
...
<div class="row">
  <div class="col-sm mt-3 mt-md-0 text-center">
    {% include figure.liquid
       loading="eager"
       path="https://wallpapers.com/images/hd/game-development-1080-x-1080-wallpaper-hrebdwrbqbhxipcr.jpg"
       title="Learning Beyond the Controller"
...
> _Great software bends two universes at once: the player’s imagination and the product backlog._
...
So I enrolled in LA County Library’s instructor‑facilitated **_How to Get Started in Game Development_**.
...
| **L4 • Immersion & Fun**                | Deconstructed Prensky’s _12 Elements of Fun_.                                                   | Stress‑test new features against **“CCCO”** (Conflict‑Competition‑Challenge‑Opposition) before backlog grooming. |
...
1. **Mock‑Up → Milestone → Playtest loops.** 5‑day cadence keeps scope visible to stakeholders _and_ my future self.
2. **Asset Ledger in Git LFS.** Every sprite, SFX, or SQL script tags owner + license + version—no more Slack archaeology.
3. **Alpha “Chaos Days.”** Borrowing from lesson‑8 testing, each Friday I run _(low battery, slow network, rotated UI, VoiceOver)_ gauntlets. If a build passes that, prod feels trivial.
...
- **Micro‑Quest Onboarding.** Borrowed _Goal → Win State → Feedback_ triad to replace monolithic tutorials with 60‑second “quests” that teach swipes, long‑presses, and calendar sync. Engagement up **18 %** week‑over‑week.
...
<div class="row">
  <div class="col-sm mt-3 mt-md-0 text-center">
    {% include figure.liquid
       loading="lazy"
       path="assets/img/stucert-l-down54663-igd-0625-TongzeMao.png"
       title="Certificate of Completion – How to Get Started in Game Development"
       class="rounded z-depth-1"
       max-width="600px"
    %}
  </div>
...
| Field          | Details                                                              |
| -------------- | -------------------------------------------------------------------- |
| **Credential** | _Certificate of Completion – How to Get Started in Game Development_ |
